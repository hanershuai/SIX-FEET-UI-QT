...
int Util::portInit(const char *device)
{
...
bool Util::send_angle_alone(unsigned char  id,int angle[22])
{
    unsigned char crc = 0;
    SendAngle[0] =  0xff;
    SendAngle[1] =  0xff;
...
bool Util::send_angle_mirror(unsigned char id_l,unsigned char id_r,int angle[22])
{
    unsigned char crc = 0;
    SendAngle[0] =  0xff;
    SendAngle[1] =  0xff;
...
bool Util::send_angle_union(int angle[22])
{
    unsigned char crc = 0;
    SendAngle[0] =  0xff;
    SendAngle[1] =  0xff;
...
bool Util::send_ID_alone(unsigned char  id)
{
    unsigned char crc = 0;
    SendAngle[0] =  0xff;
    SendAngle[1] =  0xff;
